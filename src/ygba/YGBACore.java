...
final class YGBACore implements Runnable {
    private final YGBAApplet gfxScreen;
    ...
    public YGBACore(YGBAApplet gfxScreen, ARM7TDMI cpu, Memory memory, Time time) {
        this.gfxScreen = gfxScreen;
        this.cpu = cpu;
